...
const ProductPage = async () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-ushop-purple to-ushop-pink">
        <Container>
        ...
        <Suspense
          fallback={
            <div className="flex items-center justify-center py-20">
              <div className="flex items-center gap-2 text-ushop-purple">
                <div className="w-6 h-6 border-2 border-ushop-purple border-t-transparent rounded-full animate-spin"></div>
      ...
      {/* Bottom CTA Section */}
      <div className="bg-ushop_light_bg border-t">
        <Container>
          <div className="py-12 text-center">
            ...
            <button className="inline-flex items-center gap-2 bg-ushop-purple text-white px-8 py-3 rounded-lg font-semibold hover:bg-ushop-pink transition-colors">
              Contact Support
