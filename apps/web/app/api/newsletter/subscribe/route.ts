...
<head>
    ...
    <title>Welcome to U-Shop Newsletter</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .header {
            background: linear-gradient(135deg, #6B1FA8 0%, #D4009B 100%);
            color: white;
            padding: 40px 20px;
            text-align: center;
        }
        ...
        .cta-button {
            ...
            font-weight: 600;
            font-size: 16px;
            box-shadow: 0 4px 8px rgba(107, 31, 168, 0.3);
