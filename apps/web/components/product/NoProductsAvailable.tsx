...
import { Package, Search, ArrowRight, Grid3X3, Loader2 } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative"
      >
        <div className="w-20 h-20 bg-gradient-to-br from-ushop-purple/10 to-ushop-purple/20 rounded-full flex items-center justify-center">
          <Package className="w-10 h-10 text-ushop-pink/60" />
        </div>
      ...
      >
        ...
        <p className="text-gray-600 max-w-md">
          ...
          {selectedTab && (
            <>
              in the{" "}
              <span className="font-semibold text-ushop-purple capitalize">
        ...
        <motion.div
          ...
          className="flex items-center justify-center space-x-2 text-ushop-purple mt-2"
        >
